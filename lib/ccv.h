...
ccv_convnet_t* __attribute__((warn_unused_result)) ccv_convnet_read_file(int use_cwc_accel, const char* filename);
ccv_convnet_t* __attribute__((warn_unused_result)) ccv_convnet_read_buffer(int use_cwc_accel, char* buffer);
